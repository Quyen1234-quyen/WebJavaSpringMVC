...
<html>
	<head>
		...
		<link href="<c:url value="/static/css/giohang.css"/>" rel="stylesheet" type="text/css"/>
        ...
        $(document).ready(() => {
            ...
            $('.dropdown ').on('click', () => {
                if ($(this).scrollTop() > 400) {
                    $('.submenu').addClass('active').animate({opacity:.8});
                    return true;
                }
                else{
	...
	<body>
			...
			<jsp:include page="giohang1.jsp"></jsp:include>
